    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center justify-normal bg-gray-100" style={{ minHeight: 'calc(100vh - 64px)' }}>
                ...
                <div className="bg-white p-8 border rounded-lg shadow-lg max-w-lg w-[97%] mx-auto text-center">
                    <h1 className="text-3xl font-bold">My Quick Notes 📝</h1>
                    <p className="mt-2 text-left max-w-prose mx-auto">This web app allows users to manage their own notes. It is built with <a href="https://nextjs.org/" target="_blank" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Next.js</a> and <a href="https://supabase.com/" target="_blank" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Supabase</a>. The app demonstrates <a href="https://en.wikipedia.org/wiki/Create,_read,_update_and_delete" target="_blank" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">CRUD</a> by allowing users to <b>create</b>, <b>read</b>, <b>update</b>, and <b>delete</b> notes.</p>
